...
class Asserter {
	 ...
	 * @param name
	 *            the name of the {@code Activity} that is expected to be active
	 *            e.g. {@code "MyActivity"}
	 * 
	 */
	...
	/**
	 * Asserts that an expected {@link Activity} is currently active one, with
	 * the possibility to verify that the expected {@code Activity} is a new
	 * instance of the {@code Activity}.
	 * 
	 * @param message
	 *            the message that should be displayed if the assert fails
	 * @param name
	 ...
	 *            e.g. {@code "MyActivity"}
	 * @param isNewInstance
	 *            {@code true} if the expected {@code Activity} is a new
	 *            instance of the {@code Activity}
	 * 
	 */
	...
	public void assertCurrentActivity(String message, String name,
		...
		assertCurrentActivity(message, activityUtils.getCurrentActivity()
				.getClass(), isNewInstance);
	}
	...
	public void assertCurrentActivity(String message,
		...
		Assert.assertNotSame(message + ", isNewInstance: actual and ",
				isNewInstance, found);
	}
	...
	public void assertMemoryNotLow() {
		...
		((ActivityManager) activityUtils.getCurrentActivity().getSystemService(
