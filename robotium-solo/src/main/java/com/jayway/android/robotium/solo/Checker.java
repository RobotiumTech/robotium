...
class Checker {
	 ...
	 * 
	 * @param expectedClass
	 *            the expected class, e.g. {@code CheckBox.class} or
	 *            {@code RadioButton.class}
	 * @param index
	 *            of the {@code CompoundButton} to check. {@code 0} if only one
	 *            is available
	 * @return {@code true} if {@code CompoundButton} is checked and
	 *         {@code false} if it is not checked
	 */
	 ...
	 *            {@code RadioButton.class}
	 * @param text
	 *            the text that is expected to be checked
	 * @return {@code true} if {@code CompoundButton} is checked and
	 *         {@code false} if it is not checked
	 */
	 ...
	 *            the {@code CheckedTextView} object
	 * @param text
	 *            the text that is expected to be checked
	 * @return {@code true} if {@code CheckedTextView} is checked and
	 *         {@code false} if it is not checked
	 */

	public boolean isCheckedTextChecked(String text) {
		waiter.waitForText(text, 0, 10000);
		ArrayList<CheckedTextView> list = viewFetcher
				.getCurrentViews(CheckedTextView.class);
	...
	/**
	 * Checks if a given text is selected in any {@link Spinner} located on the
	 * current screen.
	 * 
	 * @param text
	 *            the text that is expected to be selected
	 * @return {@code true} if the given text is selected in any {@code Spinner}
	 ...
	 * 
	 * @param spinnerIndex
	 *            the index of the spinner to check. 0 if only one spinner is
	 *            available
	 * @param text
	 *            the text that is expected to be selected
	 * @return true if the given text is selected in the given {@code Spinner}
	 *         and false if it is not
	 */
