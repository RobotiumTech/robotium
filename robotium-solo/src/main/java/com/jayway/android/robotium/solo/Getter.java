...
/**
 * Contains various get methods. Examples are: getView(int id), getView(Class<T>
 * classToFilterBy, int index).
 * 
...
class Getter {
	...
	public Getter(ActivityUtils activityUtils, ViewFetcher viewFetcher,
			Waiter waiter) {
	 ...
	 * @param index
	 *            choose among all instances of this type, e.g.
	 *            {@code Button.class} or {@code EditText.class}
	 * @return a {@code View} with a certain index, from the list of current
	 *         {@code View}s of the specified type
	 */
	...
	public <T extends TextView> T getView(Class<T> classToFilterBy,
