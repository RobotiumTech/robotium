...
/**
 * Contains set methods. Examples are setDatePicker(), setTimePicker().
 * 
...
class Setter {
	...
	/**
	 * Sets the progress of a given {@link ProgressBar}. Examples are SeekBar
	 * and RatingBar.
	 * 
	 * @param progressBar
	 *            the {@code ProgressBar}
	 * @param progress
	 *            the progress that the {@code ProgressBar} should be set to
	 * 
	 */
